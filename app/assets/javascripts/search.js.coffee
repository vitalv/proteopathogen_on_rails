...
$ ->
  $('.seq_link').click ->
    $("div#sequence").toggle "fast" 
    return false;


$ ->
  $("#pep_freq_table").on "click", ".pep_seq_link", ()  ->
    $("#pep_freq_table .flat_link").removeClass("flat_link")
...
$ ->  
  ...
  #this function is bound to all ".sii_link" click events, even if they are added to the DOM via ajax later
    ...
    d3.json "identification_item?sii_id=" + sii_id + "", (error, json) ->
